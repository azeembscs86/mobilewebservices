...
$_SESSION['outdoor_map_type'] = $_GET['type'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCEOuAGkPmRuwG0fcD_2KIIJiMiUNHwKV4"
    ...
    function load() {
      ...
      downloadUrl("outdoor_map_xml.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          var html = '<img height=50px width=100px src="https://design.ubuntu.com/wp-content/uploads/logo-ubuntu_su-orange-hex.png">' +" <br/> <b>" + name + "</b> <br/>" + address + " <br/>"   ;
